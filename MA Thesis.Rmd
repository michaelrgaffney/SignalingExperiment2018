...
```{r}
kable(tidy(p_comfort_signal_pinfo$model), digits = 2, caption = 'Coefficients of a linear regression model of amount confortable lending as a function of signaling condition, information, and their interaction.')
